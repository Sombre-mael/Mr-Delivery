...
import { AlertTriangle, CheckCircle2, Clock3, Home, PackageCheck, Truck } from "lucide-react";
import { getOrderByTrackingCode, getOrderEvents } from "@/lib/orders";
import { deliveryStatusLabels, type DeliveryStatus } from "@/lib/whatsapp";
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-[#fffdf7] px-4 py-12 text-ink">
        <section className="w-full max-w-lg rounded-2xl border border-ink/10 bg-white p-6 text-center shadow-soft sm:p-8">
          ...
          <a
            href="/track"
            className="mt-6 inline-flex rounded-full bg-ink px-6 py-3 text-sm font-black text-white transition hover:bg-gold hover:text-ink"
          >
            Reessayer
          </a>
        </section>
